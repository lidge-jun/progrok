  ...
  return {
    ...
    models: [
      ...
      },
      {
        ...
        type: "code",
        use: "Agentic code composition (fast)",
        input: ["text"],
        output: ["text"],
        context: "TBD",
        pricing: { note: "Hidden model — not listed in /v1/models; cost_in_usd_ticks ~$0.002-0.003/request observed", unit: "USD" },
        reasoning: { configurable: false, note: "Returns reasoning_content in response but effort parameter untested" },
        structuredOutput: false,
        functionCalling: false,
        tools: [],
        aliases: [],
        limitations: ["Not listed in /v1/models or /v1/language-models", "stop sequences return 400"],
      },
      {
        id: "grok-composer-2.5",
        type: "code",
        use: "Agentic code composition",
        input: ["text"],
        output: ["text"],
        context: "TBD",
        pricing: { note: "Team access required — not yet available to all accounts", unit: "USD" },
        reasoning: { configurable: false },
        structuredOutput: false,
        functionCalling: false,
        tools: [],
        aliases: [],
        limitations: ["Requires team-level access", "Not listed in /v1/models"],
      },
      {
